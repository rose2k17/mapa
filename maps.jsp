...
<body>
	...
	<div id="mode-selector" class="controls">
		<input type="radio" name="type" id="changemode-walking"
			checked="checked"> <label for="changemode-walking">Andando</label>

		<input type="radio" name="type" id="changemode-transit"> <label
			for="changemode-transit">Transporte público</label> <input
			type="radio" name="type" id="changemode-driving"> <label
			for="changemode-driving">Coche</label>
	</div>
	...
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKtPhLTpAp84VaOouOpfYpNII05UvbVK8&libraries=places&callback=initMap"
		async defer></script>
</body>
</html>